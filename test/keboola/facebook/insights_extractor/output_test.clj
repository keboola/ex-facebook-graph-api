...
(deftest test-primary-key
  ...
  (test-pk (sut/get-primary-key [:id :placement :foo :key2] "insights") ["id" "placement" "key2"])
  (test-pk (sut/get-primary-key [:id :placement :foo :key2] "") ["id" ])
  (test-pk (sut/get-primary-key [:id :key1 :foo :key2] "") ["id"])
    )
